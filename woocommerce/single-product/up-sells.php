...
if ( $upsells ) : 
	...
	$slider_data 	= array(
		...
		'slides_to_show'			=> pls_get_option( 'related-upsell-products-columns', 5 ),			
	...
	pls_set_loop_prop( 'products-columns', pls_get_option( 'related-upsell-products-columns', 5 ) );
	pls_set_loop_prop( 'slides_to_show', pls_get_option( 'related-upsell-products-columns', 5 ) );
	...
	<section class="up-sells upsells products">
		...
		<?php
		$heading = apply_filters( 'woocommerce_product_upsells_products_heading', __( 'You may also like&hellip;', 'anvogue' ) );
